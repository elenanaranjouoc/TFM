...
def create_expressionset_filter(expres, metadata):
    ...
    create_ExpSet <- function(expres, metadata) {
        ...
        metadatos = data.frame(labelDescription = c( "title","geo_accession","status", "submission_date","last_update_date", "type","channel_count","source_name_ch1","organism_ch1","taxid_ch1","ER","HER2","B-R grade","node status","LVI","tumor type","tumor size","treatment_protocol_ch1","molecule_ch1","extract_protocol_ch1","label_ch1","label_protocol_ch1","hyb_protocol","scan_protocol","description","data_processing","platform_id","contact_name","contact_email","contact_laboratory","contact_department","contact_institute","contact_address","contact_city","contact_state","contact_zip/postal_code","contact_country","supplementary_file","relation","series_id","data_row_count", "tumor_size_cat"),row.names=colnames(metadata))
